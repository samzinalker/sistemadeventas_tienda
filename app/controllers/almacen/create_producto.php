...
try {
    ...
    $nombre_imagen_bd = 'default_product.png';
    ...
    if (isset($_FILES['imagen_producto']) && $_FILES['imagen_producto']['error'] == UPLOAD_ERR_OK) {
        ...
        if (in_array($extension_imagen, $tipos_permitidos) && $_FILES['imagen_producto']['size'] <= 2097152) {
    ...
    $datos_producto = [
        ...
        'iva_predeterminado' => 0.00, // CAMPO AGREGADO - Puedes cambiar el valor por defecto si es necesario
        'fecha_ingreso' => $fecha_ingreso, 
        'imagen' => $nombre_imagen_bd,
    ...
    $response['message'] = "Error de base de datos: " . $e->getMessage(); // Para debugging, luego quita el mensaje específico
} catch (Exception $e) {
