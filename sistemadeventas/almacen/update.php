                                            ...
                                            <div class="col-md-9">
                                                ...
                                                <div class="row">
                                                   ...
                                                   <div class="form-group">
                                                       ...
                                                       <input type="number" name="precio_compra" value="<?= $precio_compra; ?>" class="form-control" step="0.01" min="0" required>
                                                   </div>
                                               </div>
                                               ...
                                               <div class="col-md-2">
                                                   <div class="form-group">
                                                       ...
                                                       <input type="number" name="precio_venta" value="<?= $precio_venta; ?>" class="form-control" step="0.01" min="0" required>
                                                </div>
                                               </div>
                                                    <div class="col-md-2">
                                                        <div class="form-group">
