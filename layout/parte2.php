...
<footer class="main-footer">
    ...
    <div class="float-right d-none d-sm-inline">
        Proyecto de Grado - U.E. "República de Canadá"
    </div>
    <!-- Default to the left -->
    <strong>Copyright &copy; 2025 <a href="#">Marcelo Mamani</a>.</strong> Todos los derechos reservados.
</footer>
</div>
<!-- ./wrapper -->
...
<!-- REQUIRED SCRIPTS -->
<!-- jQuery UI JS -->
<script src="<?php echo $URL;?>/public/templeates/AdminLTE-3.2.0/plugins/jquery-ui/jquery-ui.min.js"></script> 
